...
az containerapp create \
  ...
  "ACTLABS_SERVER_APPSETTING_WEBSITE_SITE_NAME=$ACTLABS_SERVER_APPSETTING_WEBSITE_SITE_NAME" \
  "ACTLABS_SERVER_ARM_MSI_API_VERSION=$ACTLABS_SERVER_ARM_MSI_API_VERSION" \
  "ACTLABS_SERVER_ARM_MSI_API_PROXY_PORT=$ACTLABS_SERVER_ARM_MSI_API_PROXY_PORT" \
