...
type Config struct {
	...
	ActlabsHubMonitorAndDeployAutoDestroyedServersToDestroyPendingDeployments bool
...
func NewConfig() (*Config, error) {
	...
	actlabsHubMonitorAndDestroyInactiveServers, err := strconv.ParseBool(getEnvWithDefault("ACTLABS_HUB_MONITOR_AND_DESTROY_INACTIVE_SERVERS", "true"))
	if err != nil {
		return nil, err
	}

	actlabsHubMonitorAndDeployAutoDestroyedServersToDestroyPendingDeployments, err := strconv.ParseBool(getEnvWithDefault("ACTLABS_HUB_MONITOR_AND_DEPLOY_AUTO_DESTROYED_SERVERS_TO_DESTROY_PENDING_DEPLOYMENTS", "true"))
	if err != nil {
		return nil, err
	}
	...
	return &Config{
		...
		ActlabsHubMonitorAndDeployAutoDestroyedServersToDestroyPendingDeployments: actlabsHubMonitorAndDeployAutoDestroyedServersToDestroyPendingDeployments,
